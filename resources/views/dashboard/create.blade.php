    ...
    <x-guest-layout>
        ...
        @csrf
            ...
            <div class="mt-4">
                ...
                <x-text-input id="sub2" class="block mt-1 w-full"  name="sub2" :value="old('sub2')" required/>
                <x-input-error :messages="$errors->get('sub2')" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-input-label for="sub3" :value="__('Subject 3')" />
                <x-text-input id="sub3" class="block mt-1 w-full"  name="sub3" :value="old('sub3')" required/>
                <x-input-error :messages="$errors->get('sub3')" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-input-label for="sub4" :value="__('Subject 4')" />
                <x-text-input id="sub4" class="block mt-1 w-full"  name="sub4" :value="old('sub4')" required/>
                <x-input-error :messages="$errors->get('sub1')" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-input-label for="sub5" :value="__('Subject 5')" />
                <x-text-input id="sub5" class="block mt-1 w-full"  name="sub5" :value="old('sub5')" required/>
                <x-input-error :messages="$errors->get('sub5')" class="mt-2" />
            </div><!-- subject -->
            <div class="mt-4">
                <x-input-label for="sub6" :value="__('Subject 6')" />
                <x-text-input id="sub6" class="block mt-1 w-full"  name="sub6" :value="old('sub6')" required/>
                <x-input-error :messages="$errors->get('sub6')" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-input-label for="sub7" :value="__('Subject 7')" />
                <x-text-input id="sub7" class="block mt-1 w-full"  name="sub7" :value="old('sub7')" required/>
